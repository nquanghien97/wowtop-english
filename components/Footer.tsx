        ...
        <div className="max-w-6xl m-auto px-4 py-7 relative z-10">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2">
              <p className="text-white mb-4 font-bold">Địa chỉ: Unit 3, 14 Canaveral drive, Rosedale, Auckland, New Zealand.</p>
              {/* <div className="mb-4">
            ...
            <div className="md:w-1/2">
              ...
              <div className="text-white">
                ...
                <p className="text-white font-bold">Địa chỉ: Unit 3, 14 Canaveral drive, Rosedale, Auckland, New Zealand.</p>
