  ...
  return (
    <main className="bg-custom-yellow">
      ...
      <section className="mb-8 bg-[url('/nen-ct.webp')] relative">
        ...
        <p className="max-lg:hidden text-[#002A9E] w-[19%] text-[0.9vw] absolute top-[18%] left-[21%]">
        ...
        <p className="max-lg:hidden text-[#002A9E] w-[16%] text-[0.9vw] absolute top-[15%] right-[22%]">
          <strong>DHA và ARA </strong>
          giúp tăng chỉ số trí tuệ, phát triển trí não & hệ thần kinh, phát triển thị lực & sáng mắt</p>
        <p className="max-lg:hidden text-[#002A9E] w-[16%] text-[0.9vw] absolute top-[46%] right-[19%]">
        ...
        <p className="max-lg:hidden text-[#002A9E] w-[14%] text-[0.9vw] absolute bottom-[25%] left-[17%]">
        ...
        <p className="max-lg:hidden text-[#002A9E] w-[16%] text-[0.9vw] absolute bottom-[24%] right-[22%]">
